...
fn test_and_true_true() {
    ...
    assert!(
        out.contains("True"),
        "True && True should be True, got: {out}"
    );
}
...
fn test_and_true_false() {
    ...
    assert!(
        out.contains("False"),
        "True && False should be False, got: {out}"
    );
}
...
fn test_or_false_true() {
    ...
    assert!(
        out.contains("True"),
        "False || True should be True, got: {out}"
    );
}
...
fn test_or_false_false() {
    ...
    assert!(
        out.contains("False"),
        "False || False should be False, got: {out}"
    );
}
...
fn test_chained_comparison_and() {
    ...
    assert!(
        out.contains("True"),
        "1 < 2 && 3 > 2 should be True, got: {out}"
    );
}
...
fn test_chained_comparison_mixed() {
    ...
    assert!(
        out.contains("False"),
        "1 < 2 && 3 < 2 should be False, got: {out}"
    );
}
...
fn test_comparison_with_variables() {
    ...
    assert!(
        out.contains("True"),
        "x=5; x > 3 should be True, got: {out}"
    );
}
...
fn test_string_equal() {
    ...
    assert!(
        out.contains("True"),
        "\"hello\" == \"hello\" should be True, got: {out}"
    );
}
...
fn test_string_not_equal() {
    ...
    assert!(
        out.contains("False"),
        "\"hello\" == \"world\" should be False, got: {out}"
    );
}
